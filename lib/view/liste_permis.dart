                  ...
                  Container(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          Center(
                            child: Text("Liste de vos demandes (${appController.permis.where((element) => element.reqUserID == appController.user!.id).toList().length})",
                              ...
                              child: OrientationBuilder(
                                ...
                                return GridView.count(
                                  ...
                                  for (Permis perm in appController.permis)
                                    if (perm.reqUserID == appController.user!.id)
            ...
            child: Container(
              ...
              child: ListTile(
                  ...
                  subtitle: Column(
                    ...
                    child: 
                      perm.status == 'VALIDE' ?
                        Text("Validé", style: TextStyle(color: Color(0xff2ebc4f)),) 
                      : perm.status == 'EN_TRTM' ? Text("En traitement", style: TextStyle(color: Colors.blue),)
                      : perm.status == 'ATTENTE_VALIDATION' ? Text("En Attente de validation", style: TextStyle(color: Colors.yellowAccent))
                      : Text("En Attente de traitement", style: TextStyle(color: Colors.black),),
            )
                    ],
                  ),
                   )),
